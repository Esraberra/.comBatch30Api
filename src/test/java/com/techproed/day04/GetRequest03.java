...
public class GetRequest03 {
    ...
    */
    ...
    public void test (){
        ...
        //request gonder
        Response response = given().accept("application/json").when().get("https://restful-booker.herokuapp.com/booking");
...
ve Response body'sinin "API" icermedigini test edin
     */
        ...
        Response response = given().accept("application/json").when().get("https://restful-booker.herokuapp.com/booking/1002");
        response.prettyPrint();
